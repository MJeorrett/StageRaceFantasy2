        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FantasyTeam_Race_RaceId",
                        column: x => x.RaceId,
                        principalTable: "Race",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    RiderRaceEntryId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    RiderId = table.Column<int>(type: "int", nullable: false),
                    RaceId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_RiderRaceEntry", x => x.RiderRaceEntryId);
                    table.ForeignKey(
                        name: "FK_RiderRaceEntry_Race_RaceId",
                        column: x => x.RaceId,
                        principalTable: "Race",
                        principalColumn: "RaceId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RiderRaceEntry_Rider_RiderId",
                        column: x => x.RiderId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RiderRaceEntry_RaceId",
                table: "RiderRaceEntry",
                column: "RaceId");

            migrationBuilder.CreateIndex(
                name: "IX_RiderRaceEntry_RiderId_RaceId",
                table: "RiderRaceEntry",
                columns: new[] { "RiderId", "RaceId" });
        }
